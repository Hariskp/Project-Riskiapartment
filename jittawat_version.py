...
#LOGIN FRAME [ หน้าการเข้าสู่ระบบของโปรแกรม ]
def login_fn() : 
    #MAIN WINDOW
    ...
    #LEFT SIDE [ ช่องกรอกรหัสผ่านเข้าสู่ระบบและปุ่มล็อคอิน ]
    ...
    frm_left_login_entry_username = Entry(frm_left_login, width=30, bg='#E6E6E6', bd=0) #ENTRY กรอกไอดี *
    ...
    frm_left_login_entry_password = Entry(frm_left_login, width=30, bg='#E6E6E6', bd=0,show="*") #ENTRY กรอกรหัสผ่าน *
    frm_left_login_entry_password.place(x=380, y=580, height=50)
    Button(frm_left_login, image=btn_login, bd=0, bg='white', command=home_fn).place(x=480, y=680) #LOGIN_BTN ปุ่มล็อคอิน *

    #RIGHT SIDE [ แบนเนอร์ของโปรแกรม ]
...
def home_fn() :
    ...
    #LEFT SIDE [ ปุ่มทั้งหมดของหน้าหลัก ]
    Button(frm_left_home, image=img_riskilogos, bg='#084235', command=home_fn, bd=0).place(x=30, y=30) #HOME_BTN ปุ่มหน้าหลัก *
    Button(frm_left_home, image=btn_checkinout, bd=0, bg='#084235', command=checkinout_fn).place(x=180, y=180) #CHECKINOUT_BTN ปุ่มเขียว *
    Button(frm_left_home, image=btn_inforeport, bd=0, bg='#084235', command=datareporttable_fn).place(x=180, y=280) #INFOREPORT_BTN ปุ่มข้อมูลและรายงาน *
    Button(frm_left_home, image=btn_accmanage, bd=0, bg='#084235', command=accountmanage_fn).place(x=180, y=380) #ACCMANAGE_BTN ปุ่มจัดการบัญชี *
    Button(frm_left_home, image=btn_roommanage, bd=0, bg='#084235', command=roommanage_fn).place(x=180, y=480) #ROOMMANAGE_BTN ปุ่มจัดการห้องพัก *
    Button(frm_left_home, image=btn_service, bd=0, bg='#084235', command=service_fn).place(x=180, y=580) #SERVICE_BTN ปุ่มบริการต่างๆ*
    Button(frm_left_home, image=btn_signout, bd=0, bg='#084235', command=login_fn).place(x=30, y=900) #SIGNOUT_BTN ปุ่มแดง *

    #CREATE TREEVIEW [ ตารางของชั้น เลขห้อง สถานะห้อง ]
...
#CHECKINOUT FRAME [ เช็ตอิน เช็คเอ้าท์ ]
def checkinout_fn() : 
    #MAIN
    ...
    #LEFT SIDE [ ปุ่มภายในหน้าเช็คอิน เช็คเเอ้าท์ ]
    Button(frm_left_inout, image=btn_checkinout, bd=0 , bg='#084235').place(x=180, y=180) #CHECKINOUT_BTN ปุ่มเขียว *
    Button(frm_left_inout, image=btn_checkin, bd=0, bg='#084235', command=checkin_fn).place(x=198, y=280) #CHECKIN_BTN ปุ่มหน้าเช็คอิน *
    Button(frm_left_inout, image=btn_checkout, bd=0, bg='#084235', command=checkout_fn).place(x=198, y=380) #CHECKOUT_BTN ปุ่มหน้าเช็คเอ้าท์ *
    Button(frm_left_inout, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
...
#CHECKIN FRAME [ หน้าต่างเช็คอินของโปรแกรม ]
def checkin_fn() : 
    #MAIN
    ...
    #LEFT SIDE [ ปุ่มทั้งหมดทางเฟรมซ้าย ]
    ...
    #RIGHT SIDE [ ช่องกรอก เบอร์ ชื่อ , ปุ่มค้นหา ]
    ...
    entry_phonenum_checkin = Entry(frm_right_checkin_bg).place(x=350, y=60) #ENTRY กรอกเบอร์โทร *
    Button(frm_right_checkin_bg, image=btn_search, bd=0, bg='#DDDDDD').place(x=670, y=58) #SEARCH_BTN ปุ่มค้นหา * 
    Label(frm_right_checkin_bg, text='ชื่อ-นามสกุล : ', bg='#DDDDDD').place(x=183, y=120)
    entry_name_checkin = Entry(frm_right_checkin_bg).place(x=350, y=120) #ENTRY กรอกชื่อ นามสกุล *
    Label(frm_right_checkin_bg, text='ประเภทห้อง : ', bg='#DDDDDD').place(x=198, y=180)

    #ROOM TYPE [ ประเภทของห้อง , ช่องกรอก ชั้น ราคา , ปุ่ม ]
    ...
    entry_floor_checkin = Entry(frm_right_checkin_bg).place(x=350, y=240) #ENTRY กรอกชั้น *
    Label(frm_right_checkin_bg, text='ราคา : ', bg='#DDDDDD').place(x=259, y= 300)
    entry_price_checkin = Entry(frm_right_checkin_bg).place(x=350, y=300) #ENTRY กรอกราคา * 
    Button(frm_right_checkin_bg, image=btn_next,bd=0, bg='#DDDDDD', command=checkin_date).place(x=480, y=450) #NEXT_BTN ปุ่มถัดไป * 

#CHECKINDATE FRAME [ หน้าต่างของวันที่เช็คอิน ]
def checkin_date() : 
    #MAIN
    root.title("Riski Apartment : เช็คอิน")
    ...
    #LOGO
    Button(frm_left_checkindate, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมซ้าย ]
    Button(frm_left_checkindate, image=btn_checkinout, bd=0 , bg='#084235').place(x=180, y=180) #CHECKINOUT_BTN ปุ่มเขียว  *
    Button(frm_left_checkindate, image=btn_checkin, bd=0, bg='#084235', command=checkin_fn).place(x=198, y=280) #CHECKIN_BTN ปุ่มเช็คอิน *
    Button(frm_left_checkindate, image=btn_checkout, bd=0, bg='#084235', command=checkout_fn).place(x=198, y=380) #CHECKOUT_BTN ปุ่มเช็คเอ้าท์ *
    Button(frm_left_checkindate, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ช่องกรอก เริ่มวันที่ สิ้นสุดวันที่ เจ้าหน้าที่ , ปุ่มกลับ เสร็จสิ้น ปริ้นท์ใบ ]
    ...
    entry_startdate_in = Entry(frm_right_checkindate_bg).place(x=250, y=60) #ENTRY กรอกวันที่เริ่ม *
    ...
    entry_enddate_in = Entry(frm_right_checkindate_bg).place(x=250, y=120) #ENTRY กรอกวันที่สิ้นสุด *
    ...
    entry_user_in = Entry(frm_right_checkindate_bg).place(x=250, y=180) #ENTRY กรอกเจ้าหน้าที่ * /////////////////////////
    Button(frm_right_checkindate_bg, image=btn_back,bd=0, bg='#DDDDDD', command=checkin_fn).place(x=150, y=250) #BACK_BTN ปุ่มกลับ  *
    Button(frm_right_checkindate_bg, image=btn_finish,bd=0, bg='#DDDDDD').place(x=450, y=250) #FINISH_BTN ปุ่มเสร็จสิ้น  *
    Button(frm_right_checkindate_bg, image=btn_paperform,bd=0, bg='#DDDDDD').place(x=280, y=360) #PAPERORM_BTN ปริ้นใบ  *

#CHECKOUT FRAME [ หน้าต่างเช็คเอ้าท์ของโปรแกรม ]
def checkout_fn() :
    #MAIN
    ...
    #LOGO
    Button(frm_left_checkout, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #CHECKINOUT_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมซ้าย ]
    Button(frm_left_checkout, image=btn_checkinout, bd=0 , bg='#084235').place(x=180, y=180) #HOME_BTN ปุ่มเขียว *
    Button(frm_left_checkout, image=btn_checkin, bd=0, bg='#084235', command=checkin_fn).place(x=198, y=280) #CHECKIN_BTN ปุ่มเช็คอิน *
    Button(frm_left_checkout, image=btn_checkout, bd=0, bg='#084235', command=checkout_fn).place(x=198, y=380) #CHECKOUT_BTN ปุ่มเช็คเอ้าท์ *
    Button(frm_left_checkout, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
    
    #RIGHT SIDE [ ช่องกรอกเบอร์ ชื่อ เลขห้อง ประเภทห้อง ชั้น , ปุ่มยืนยัน ]
    ...
    entry_phonenum_checkout = Entry(frm_right_checkout_bg).place(x=350, y=60) #ENTRY กรอกเบอร์โทร *
    Button(frm_right_checkout_bg, image=btn_search, bd=0, bg='#DDDDDD').place(x=670, y=58) #>>> GET DATA FROM DATABASE SQLITE3
    Label(frm_right_checkout_bg, text='ชื่อ-นามสกุล : ', bg='#DDDDDD').place(x=183, y=120)
    entry_name_checkout = Entry(frm_right_checkout_bg).place(x=350, y=120) #>>> GET DATA FROM DATABASE SQLITE3          
    Label(frm_right_checkout_bg, text='เลขห้อง : ', bg='#DDDDDD').place(x=232, y=180)
    entry_roomnum_checkout = Entry(frm_right_checkout_bg).place(x=350, y=180) #ENTRY กรอกเลขห้อง * 
    #room type
    Label(frm_right_checkout_bg, text='ประเภทห้อง : ', bg='#DDDDDD').place(x=200, y= 240)
    entry_roomtype_checkout = Entry(frm_right_checkout_bg).place(x=350, y=240) #ENTRY กรอกประเภทห้อง *
    Label(frm_right_checkout_bg, text='ชั้น : ', bg='#DDDDDD').place(x=275, y= 300)
    entry_floor_checkout = Entry(frm_right_checkout_bg).place(x=350, y=300) #ENTRY กรอกชั้น *
...
#CHECKOUTDATE FRAME [ หน้าต่างเช็คเอ้าท์ของโปรแกรม ]
def checkout_date() : #หน้า Check Out ที่ 2 #โค้ดนี้กำลังแก้ไขโดย นัท 07/04/2023 เวลา 3:09
    ...
    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมซ้าย ]
    Button(frm_left_checkoutdate, image=btn_checkinout, bd=0 , bg='#084235').place(x=180, y=180) #CHECKINOUT_BTN ปุ่มเขียว *
    Button(frm_left_checkoutdate, image=btn_checkin, bd=0, bg='#084235', command=checkin_fn).place(x=198, y=280) #CHECKIN_BTN ปุ่มเช็คอิน *
    Button(frm_left_checkoutdate, image=btn_checkout, bd=0, bg='#084235', command=checkout_fn).place(x=198, y=380) #CHECKOUT_BTN ปุ่มเช็คเอ้าท์ *
    Button(frm_left_checkoutdate, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ช่องกรอกวันเริ่ม สิ้นสุด เจ้าหน้าที่ , ปุ่มกลับ เสร็จสิ้น ]
    ...
    entry_startdate_out = Entry(frm_right_checkoutdate_bg).place(x=250, y=60) #ENTRY กรอกวันที่เริ่ม *
    Label(frm_right_checkoutdate_bg, text='สิ้นสุดวันที่ : ', bg='#DDDDDD').place(x=109, y=120)
    entry_endate_out = Entry(frm_right_checkoutdate_bg).place(x=250, y=120) #ENTRY กรอกวันที่สิ้นสุด *
    ...
    entry_user_out = Entry(frm_right_checkoutdate_bg).place(x=250, y=180) #ENTRY กรอกเจ้าหน้าที่ *
    Button(frm_right_checkoutdate_bg, image=btn_back,bd=0, bg='#DDDDDD', command=checkout_fn).place(x=150, y=250) #BACK_BTN ปุ่มกลับ *
    Button(frm_right_checkoutdate_bg, image=btn_finish,bd=0, bg='#DDDDDD').place(x=450, y=250) #FINISH_BTN ปุ่มเสร็จสิ้น *
 
#ACCOUNT MANAGE FRAME [ หน้่าต่างการจัดการห้องพักของโปรแกรม ]
def accountmanage_fn() : 
    ...
    #LOGO
    Button(frm_left_accmanage, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT
    Label(frm_left_accmanage, image=btn_empmanage, bd=0 , bg='#084235').place(x=125, y=185)
    Button(frm_left_accmanage, image=btn_addempacc, bd=0 , bg='#084235', command=addempaccount_fn).place(x=180, y=270) #ADDEMPACC_BTN ปุ่มเพิ่มบัญชีพนักงาน *
    Button(frm_left_accmanage, image=btn_editempacc, bd=0 , bg='#084235', command=editempaccount_fn).place(x=180, y=350) #EDITEMPACC_BTN ปุ่มแก้ไขข้อมูลพนักงาน *
    Label(frm_left_accmanage, image=btn_cusmanage, bd=0 , bg='#084235').place(x=125, y=435)
    Button(frm_left_accmanage, image=btn_addcusinfo, bd=0 , bg='#084235', command=addcustomerinfo_fn).place(x=180, y=520) #ADDCUSINFO_BTN ปุ่มเพิ่มบัญชีลูกค้า *
    Button(frm_left_accmanage, image=btn_editcusinfo, bd=0 , bg='#084235', command=searchcusinfo_fn).place(x=180, y=600) #EDITCUSINFO_BTN ปุ่มแก้ไขข้อมูลลูกค้า *
    Button(frm_left_accmanage, image=btn_home, command=home_fn, bd=0, bg='#084235').place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
...
#ADD EMPLOYEE ACCOUNT [ หน้าต่างการเพิ่มบัญชีพนักงานของโปรแกรม ]
def addempaccount_fn() :
    ...
    #LOGO
    Button(frm_left_addempaccount, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT
    Label(frm_left_addempaccount, image=btn_empmanage, bd=0 , bg='#084235').place(x=125, y=185)
    Button(frm_left_addempaccount, image=btn_addempacc, bd=0 , bg='#084235', command=addempaccount_fn).place(x=180, y=270) #ADDEMPACC_BTN ปุ่มเพิ่มบัญชีพนักงาน *
    Button(frm_left_addempaccount, image=btn_editempacc, bd=0 , bg='#084235', command=editempaccount_fn).place(x=180, y=350) #EDITEMPACC_BTN ปุ่มแก้ไขข้อมูลพนักงาน *
    Label(frm_left_addempaccount, image=btn_cusmanage, bd=0 , bg='#084235').place(x=125, y=435)
    Button(frm_left_addempaccount, image=btn_addcusinfo, bd=0 , bg='#084235', command=addcustomerinfo_fn).place(x=180, y=520) #ADDCUSINFO_BTN ปุ่มเพิ่มบัญชีลูกค้า *
    Button(frm_left_addempaccount, image=btn_editcusinfo, bd=0 , bg='#084235', command=searchcusinfo_fn).place(x=180, y=600) #EDITCUSINFO_BTN ปุ่มแก้ไขข้อมูลลูกค้า
    Button(frm_left_addempaccount, image=btn_home, command=home_fn, bd=0, bg='#084235').place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
    ...
    entry_name_addempaccount = Entry(frm_right_addempaccount_bg).place(x=270, y=50, width=230) #ENTRY กรอกชื่อ *
    Label(frm_right_addempaccount_bg, text='นามสกุล : ', bg='#DDDDDD').place(x=603, y=50)
    entry_surname_addempaccount = Entry(frm_right_addempaccount_bg).place(x=730, y=50, width=230) #ENTRY กรอกนามสกุล *
    Label(frm_right_addempaccount_bg, text='Username : ', bg='#DDDDDD').place(x=111, y=120)
    entry_username_addempaccount = Entry(frm_right_addempaccount_bg).place(x=270, y=120, width=230) #ENTRY กรอกไอดี *
    Label(frm_right_addempaccount_bg, text='Password : ', bg='#DDDDDD').place(x=570, y=120)
    entry_password_addempaccount = Entry(frm_right_addempaccount_bg).place(x=730, y=120, width=230) #ENTRY กรอกรหัสผ่าน *
    Label(frm_right_addempaccount_bg, text='เบอร์โทร : ', bg='#DDDDDD').place(x=152, y=190)
    entry_phone_addempaccount = Entry(frm_right_addempaccount_bg).place(x=270, y=190, width=230) #ENTRY กรอกเบอร์โทร *
    Button(frm_right_addempaccount_bg, image=btn_save, bd=0, bg='#DDDDDD').place(x=790, y=220) #SAVE_BTN ปุ่มเซฟ *

    #CREATE TREEVIEW [ ไอดี รหัสผ่าน ชื่อ นามสกุล เบอร์โทร ]
    mytree = ttk.Treeview(root)
...
#EDITEMPLOYEEACCOUNT FRAME [ หน้าต่างการแก้ไขข้อมูลพนักงาน ]
def editempaccount_fn() : 
    ...
    #LEFT SIDE [ ปุ่มเพิ่มพนักงาน แก้ไขพนักงาน เพิ่มลูกค้า แก้ไขลูกค้า ]
    Label(frm_left_editempaccount, image=btn_empmanage, bd=0 , bg='#084235').place(x=125, y=185)
    Button(frm_left_editempaccount, image=btn_addempacc, bd=0 , bg='#084235', command=addempaccount_fn).place(x=180, y=270) #ADDEMPACC_BTN ปุ่มเพิ่มบัญชีพนักงาน *
    Button(frm_left_editempaccount, image=btn_editempacc, bd=0 , bg='#084235', command=editempaccount_fn).place(x=180, y=350) #EDITEMPACC_BTN ปุ่มแก้ไขบัญชีพนักงาน *
    Label(frm_left_editempaccount, image=btn_cusmanage, bd=0 , bg='#084235').place(x=125, y=435)
    Button(frm_left_editempaccount, image=btn_addcusinfo, bd=0 , bg='#084235', command=addcustomerinfo_fn).place(x=180, y=520) #ADDCUSINFO_BTN ปุ่มเพิ่มบัญชีลูกค้า *
    Button(frm_left_editempaccount, image=btn_editcusinfo, bd=0 , bg='#084235', command=searchcusinfo_fn).place(x=180, y=600) #EDITCUSINFO_BTN ปุ่มแก้ไขบัญชีลูกค้า *
    Button(frm_left_editempaccount, image=btn_home, command=home_fn, bd=0, bg='#084235').place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ปุ่มค้นหา ช่องกรอกค้นหาเบอร์โทร ชื่อ นามสกุล ไอดี รหัสผ่าน]
    ...
    entry_findphone_editempaccount = Entry(frm_right_editempaccount_bg).place(x=500, y=50, width=250) #ENTRY กรอกค้นหาเบอร์โทร * 
    Button(frm_right_editempaccount_bg, image=btn_search, bd=0, bg='#DDDDDD').place(x=780, y=50) #SEARCH_BTN ปุ่มค้นหา *
    Label(frm_right_editempaccount_bg, text='ชื่อ : ', bg='#DDDDDD').place(x=200, y=100)
    entry_name_editempaccount = Entry(frm_right_editempaccount_bg).place(x=270, y=100, width=230) #ENTRY กรอกชื่อ *
    Label(frm_right_editempaccount_bg, text='นามสกุล : ', bg='#DDDDDD').place(x=603, y=100)
    entry_surname_editempaccount = Entry(frm_right_editempaccount_bg).place(x=730, y=100, width=230) #ENTRY กรอกนามสกุล *
    Label(frm_right_editempaccount_bg, text='Username : ', bg='#DDDDDD').place(x=111, y=150)
    entry_username_editempaccount = Entry(frm_right_editempaccount_bg).place(x=270, y=150, width=230) #ENTRY กรอกไอดี *
    Label(frm_right_editempaccount_bg, text='Password : ', bg='#DDDDDD').place(x=570, y=150)
    entry_password_editempaccount = Entry(frm_right_editempaccount_bg).place(x=730, y=150, width=230) #ENTRY กรอกรหัสผ่าน *
    Label(frm_right_editempaccount_bg, text='เบอร์โทร : ', bg='#DDDDDD').place(x=152, y=200)
    entry_phone_editempaccount = Entry(frm_right_editempaccount_bg).place(x=270, y=200, width=230) #ENTRY กรอกเบอร์โทร *
    Button(frm_right_editempaccount_bg, image=btn_delete, bd=0, bg='#DDDDDD').place(x=580, y=240) #DELETE_BTN ปุ่มลบ *
    Button(frm_right_editempaccount_bg, image=btn_edit, bd=0, bg='#DDDDDD').place(x=790, y=240) #EDIT_BTN ปุ่มแก้ไข *
...
#ADDCUSTOMERINFO FRAME [ หน้าต่างของการเพิ่มข้อมูลลูกค้า ]
def addcustomerinfo_fn() : 
    #MAIN
    ...
    #LEFT SIDE [ ปุ่มเพิ่มบัญชีพนักงาน แก้ไขบัญชีพนักงาน เพิ่มบัญชีลูกค้า แก้ไขบัญชีลูกค้า ]
    Label(frm_left_addcusinfo, image=btn_empmanage, bd=0 , bg='#084235').place(x=125, y=185)
    Button(frm_left_addcusinfo, image=btn_addempacc, bd=0 , bg='#084235', command=addempaccount_fn).place(x=180, y=270) #ADDEMPACC_BTN ปุ่มเพิ่มบัญชีพนักงาน *
    Button(frm_left_addcusinfo, image=btn_editempacc, bd=0 , bg='#084235', command=editempaccount_fn).place(x=180, y=350) #EDITEMPACC_BTN ปุ่มแก้ไขข้อมูลพนักงาน *
    Label(frm_left_addcusinfo, image=btn_cusmanage, bd=0 , bg='#084235').place(x=125, y=435)
    Button(frm_left_addcusinfo, image=btn_addcusinfo, bd=0 , bg='#084235', command=addcustomerinfo_fn).place(x=180, y=520) #ADDCUSINFO_BTN ปุ่มเพิมข้อมูลลูกค้า *
    Button(frm_left_addcusinfo, image=btn_editcusinfo, bd=0 , bg='#084235', command=searchcusinfo_fn).place(x=180, y=600) #EDITCUSINFO_BTN ปุ่มแก้ไขข้อมูลลูกค้า *
    Button(frm_left_addcusinfo, image=btn_home, command=home_fn, bd=0, bg='#084235').place(x=30, y=900)

    #RIGHT SIDE [กรอกชื่อ นามสกุล เบอร์โทร เชื้อชาติ สัญชาติ บ้านเลขที่ หมู่บ้าน ถนน ตำบล อำเภอ จังหวัด , ปุ่มบันทึก]
    ...
    entry_name_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=170, y=50) #ENTRY กรอกชื่อ *
    Label(frm_right_addcusinfo_bg, text='นามสกุล : ', bg='#DDDDDD').place(x=59, y=150)
    entry_surname_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=170, y=150) #ENTRY กรอกนามสกุล *
    Label(frm_right_addcusinfo_bg, text='เบอร์โทร : ', bg='#DDDDDD').place(x=61, y=250)
    entry_phone_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=170, y=250) #ENTRY กรอกเบอร์โทร *
    Label(frm_right_addcusinfo_bg, text='เชื้อชาติ : ', bg='#DDDDDD').place(x=65, y=350)
    entry_ethnicity_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=170, y=350) #ENTRY กรอกเชื้อชาติ #ศัพท์จาก apple translate
    Label(frm_right_addcusinfo_bg, text='สัญชาติ : ', bg='#DDDDDD').place(x=67, y=450)
    entry_nation_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=170, y=450) #ENTRY กรอกสัญชาติ *  #nation --> nationality
    Label(frm_right_addcusinfo_bg, text='บ้านเลขที่ : ', bg='#DDDDDD').place(x=600, y=50)
    entry_number_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=720, y=50) #ENTRY กรอกบ้านเลขที่ * #บ้านเลขที่ --> number , จะเปลี่ยนก็ได้ตามใจชอบบ
    Label(frm_right_addcusinfo_bg, text='หมู่บ้าน : ', bg='#DDDDDD').place(x=621, y=150)
    entry_village_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=720, y=150) #ENTRY กรอกหมู่บ้าน *
    Label(frm_right_addcusinfo_bg, text='ถนน : ', bg='#DDDDDD').place(x=645, y=250)
    entry_road_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=720, y=250) #ENTRY กรอกถนน *
    Label(frm_right_addcusinfo_bg, text='ตำบล/แขวง : ', bg='#DDDDDD').place(x=578, y=350)
    entry_subdistrict_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=720, y=350) #ENTRY กรอกตำบล *
    Label(frm_right_addcusinfo_bg, text='อำเภอ/เขต : ', bg='#DDDDDD').place(x=588, y=450)
    entry_district_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=720, y=450) #ENTRY กรอกอำเภอ *
    Label(frm_right_addcusinfo_bg, text='จังหวัด : ', bg='#DDDDDD').place(x=632, y=550)
    entry_province_addcusinfo = Entry(frm_right_addcusinfo_bg).place(x=720, y=550) #ENTRY กรอกจังหวัด *
    Button(frm_right_addcusinfo_bg, image=btn_longsave, bd=0, bg='#DDDDDD').place(x=760, y=650) #LONGSAVE_BTN ปุ่มบันทึก *

#SEARCHCUSTOMERINFO FRAME [ หน้าต่างการค้นหาแก้ไขข้อมูลของลูกค้า ]
def searchcusinfo_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_searchcusinfo, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมซ้าย ]
    Label(frm_left_searchcusinfo, image=btn_empmanage, bd=0 , bg='#084235').place(x=125, y=185)
    Button(frm_left_searchcusinfo, image=btn_addempacc, bd=0 , bg='#084235', command=addempaccount_fn).place(x=180, y=270) #ADDEMPACC_BTN ปุ่มเพิ่มบัญชีพนักงาน *
    Button(frm_left_searchcusinfo, image=btn_editempacc, bd=0 , bg='#084235', command=editempaccount_fn).place(x=180, y=350) #EDITEMPACC_BTN ปุ่มแก้ไขข้อมูลบัญชีพนักงาน *
    Label(frm_left_searchcusinfo, image=btn_cusmanage, bd=0 , bg='#084235').place(x=125, y=435)
    Button(frm_left_searchcusinfo, image=btn_addcusinfo, bd=0 , bg='#084235', command=addcustomerinfo_fn).place(x=180, y=520) #ADDCUSINFO_BTN ปุ่มเพิ่มข้อมูลลูกค้า *
    Button(frm_left_searchcusinfo, image=btn_editcusinfo, bd=0 , bg='#084235', command=searchcusinfo_fn).place(x=180, y=600) #EDITCUSINFO_BTN ปุ่มแก้ไขข้อมูลลูกค้า *
    Button(frm_left_searchcusinfo, image=btn_home, command=home_fn, bd=0, bg='#084235').place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ช่องกรอกเบอร์โทร ชื่อนามสกุล , ปุ่มค้นหา ลบ แก้ไข ]
    ...
    entry_phone_editcus = Entry(frm_right_searchcusinfo_bg).place(x=300, y=70) #ENTRY กรอกเบอร์โืทร *
    Button(frm_right_searchcusinfo_bg, image=btn_search, bd=0, bg='#DDDDDD').place(x=620, y=68)
    Label(frm_right_searchcusinfo_bg, text='ชื่อ-นามสกุล : ', bg='#DDDDDD', bd=0).place(x=154, y=140) #>>> GET DATA FROM DATABASE SQLITE3 
    entry_name_editcus = Entry(frm_right_searchcusinfo_bg).place(x=300, y=140) #ENTRY กรอกชื่อ นามสกุล *
    Button(frm_right_searchcusinfo_bg, image=btn_deleteinfo, bd=0, bg='#DDDDDD').place(x=200, y=270) #DELETEINFO_BTN ปุ่มลบข้อมูล *
    Button(frm_right_searchcusinfo_bg, image=btn_edit, bd=0, bg='#DDDDDD', command=editcusinfo_fn).place(x=430, y=270) #EDIT_BTN ปุ่มแก้ไข *

#EDITCUSTOMERINFO FRAME [ หน้าต่างแก้ไขข้อมูลลูกค้าของโปรแกรม ]
def editcusinfo_fn() : 
    #MAIN
    root.title("Riski Apartment : แก้ไขข้อมูลลูกค้า")
    ...
    #LOGO
    Button(frm_left_editcusinfo, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT SIDE [ ปุ่มเพิ่มบัญชี แก้ไขบัญชี เพิ่มลูกค้า แก้ไขลูกค้า หน้าหลัก ]
    Label(frm_left_editcusinfo, image=btn_empmanage, bd=0 , bg='#084235').place(x=125, y=185)
    Button(frm_left_editcusinfo, image=btn_addempacc, bd=0 , bg='#084235', command=addempaccount_fn).place(x=180, y=270) #ADDEMPACC_BTN ปุ่มเพิ่มบัญชีพนักงาน *
    Button(frm_left_editcusinfo, image=btn_editempacc, bd=0 , bg='#084235', command=editempaccount_fn).place(x=180, y=350) #EDITEMPACC_BTN ปุ่มแก้ไขบัญชีพนักงาน *
    Label(frm_left_editcusinfo, image=btn_cusmanage, bd=0 , bg='#084235').place(x=125, y=435)
    Button(frm_left_editcusinfo, image=btn_addcusinfo, bd=0 , bg='#084235', command=addcustomerinfo_fn).place(x=180, y=520) #ADDCUSINFO_BTN ปุ่มเพิ่มข้อมูลลูกค้า *
    Button(frm_left_editcusinfo, image=btn_editcusinfo, bd=0 , bg='#084235', command=searchcusinfo_fn).place(x=180, y=600) #EDITCUSINFO_BTN ปุ่มแก้ไขข้อมูลลูกค้า *
    Button(frm_left_editcusinfo, image=btn_home, command=home_fn, bd=0, bg='#084235').place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ช่องกรอกชื่อ นามสกุล เบอร์โทร สัญชาติ เชื้อชาติ บ้านเลขที่ หมู่บ้าน ถนน ตำบล อำเภแ จังหวัด , ปุ่มบันทึก ]
    ...
    entry_name_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=170, y=50) #ENTRY กรอกชื่อ *
    Label(frm_right_editcusinfo_bg, text='นามสกุล : ', bg='#DDDDDD', bd=0).place(x=59, y=150)
    entry_surname_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=170, y=150) #ENTRY กรอกนามสกุล *
    Label(frm_right_editcusinfo_bg, text='เบอร์โทร : ', bg='#DDDDDD').place(x=61, y=250)
    entry_phone_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=170, y=250) #ENTRY กรอกเบอร์โทร *
    Label(frm_right_editcusinfo_bg, text='เชื้อชาติ : ', bg='#DDDDDD').place(x=65, y=350)
    entry_ethnicity_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=170, y=350) #ENTRY กรอกเชื้อชาติ *
    Label(frm_right_editcusinfo_bg, text='สัญชาติ : ', bg='#DDDDDD').place(x=67, y=450)
    entry_nation_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=170, y=450) #ENTRY กรอกสัญชาติ *
    Label(frm_right_editcusinfo_bg, text='บ้านเลขที่ : ', bg='#DDDDDD').place(x=600, y=50)
    entry_number_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=720, y=50) #ENTRY กรอกบ้านเลขที่ *
    Label(frm_right_editcusinfo_bg, text='หมู่บ้าน : ', bg='#DDDDDD').place(x=621, y=150)
    entry_village_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=720, y=150) #ENTRY กรอกหมู่บ้าน *
    Label(frm_right_editcusinfo_bg, text='ถนน : ', bg='#DDDDDD').place(x=645, y=250)
    entry_road_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=720, y=250) #ENTRY กรอกถนน *
    Label(frm_right_editcusinfo_bg, text='ตำบล/แขวง : ', bg='#DDDDDD').place(x=578, y=350)
    entry_subdistrict_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=720, y=350) #ENTRY กรอกตำบล *
    Label(frm_right_editcusinfo_bg, text='อำเภอ/เขต : ', bg='#DDDDDD').place(x=588, y=450)
    entry_district_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=720, y=450) #ENTRY กรอกอำเภอ *
    Label(frm_right_editcusinfo_bg, text='จังหวัด : ', bg='#DDDDDD').place(x=632, y=550)
    entry_province_editcusinfo = Entry(frm_right_editcusinfo_bg).place(x=720, y=550) #ENTRY กรอกจังหวัด *
    Button(frm_right_editcusinfo_bg, image=btn_longsave, bd=0, bg='#DDDDDD').place(x=760, y=650) #LONGSAVE_BTN ปุ่มบันทึก *

#ROOMMANAGEMENT FRAME [ หน้าต่างการเช็คห้องพักของโปรแกรม ]
def roommanage_fn(): 
    #MAIN
    ...
    #LOGO
    Button(frm_left_roommanage, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมซ้าย ]
    Button(frm_left_roommanage, image=btn_CheckRoom, bd=0 , bg='#084235', command=roommanage_fn).place(x=125, y=185) #CHECKROOM_BTN ปุ่มเช็คห้องพัก *
    Label(frm_left_roommanage, image=btn_roommanage_V2, bd=0, bg='#084235').place(x=125, y=280) 
    Button(frm_left_roommanage, image=btn_addRoom, bd=0, bg='#084235', command=addRoom_fn).place(x=180, y=365) #ADDROOM_BTN ปุ่มเพิ่มห้องพัก *
    Button(frm_left_roommanage, image=btn_editRoom, bd=0, bg='#084235', command=editRoom_fn).place(x=180, y=440) #EDITROOM_BTN ปุ่มแก้ไขห้องพัก *
    Button(frm_left_roommanage, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #CREATE TREEVIEW [ ชั้น เลขห้อง สถานะ ]
    mytree = ttk.Treeview(root)
...
#ADDROOM FRAME [ หน้าต่างการเพิ่มห้องพักของโปรแกรม ]
def addRoom_fn(): 
    ...
    #LOGO
    Button(frm_left_addRoom, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมซ้าย ]
    Button(frm_left_addRoom, image=btn_CheckRoom, bd=0 , bg='#084235', command=roommanage_fn).place(x=125, y=185) #CHECKROOM_BTN ปุ่มเช็คห้องพัก *
    Label(frm_left_addRoom, image=btn_roommanage_V2, bd=0, bg='#084235').place(x=125, y=280)
    Button(frm_left_addRoom, image=btn_addRoom, bd=0, bg='#084235', command=addRoom_fn).place(x=180, y=365) #ADDROOM_BTN ปุ่มเพิ่มห้องพัก *
    Button(frm_left_addRoom, image=btn_editRoom, bd=0, bg='#084235', command=editRoom_fn).place(x=180, y=440) #EDITROOM_BTN ปุ่มแก้ไขห้องพัก *
    Button(frm_left_addRoom, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
     
    #RIGHT SIDE [ ช่องกรอก เลขห้อง ชั้น ]
    ...
    entry_phonenum_checkin = Entry(frm_right_addRoom_bg).place(x=350, y=60) #ENTRY กรอกห้องเลขที่ * 
    Label(frm_right_addRoom_bg, text='ชั้น : ', bg='#DDDDDD').place(x=272, y=120)
    entry_name_addRoom = Entry(frm_right_addRoom_bg).place(x=350, y=120) #ENTRY กรอกชั้น *
    ...
    Button(frm_right_addRoom_bg, image=btn_add,bd=0, bg='#DDDDDD',).place(x=485, y=270) #ADD_BTN ปุ่มเพิ่ม *

#EDITROOM FRAME [ หน้าต่างการแก้ไขห้องพักของโปรแกรม ]
def editRoom_fn(): 
    ...
    #LEFT SIDE [ปุ่มทั้งหมดของเฟรมซ้าย ]
    Button(frm_left_editRoom, image=btn_CheckRoom, bd=0 , bg='#084235', command=roommanage_fn).place(x=125, y=185) #CHECKROOM_BTN ปุ่มเช็คห้องพัก *
    Label(frm_left_editRoom, image=btn_roommanage_V2, bd=0, bg='#084235').place(x=125, y=280)
    Button(frm_left_editRoom, image=btn_addRoom, bd=0, bg='#084235', command=addRoom_fn).place(x=180, y=365) #ADDROOM_BTN ปุ่มเพิ่มห้องพัก *
    Button(frm_left_editRoom, image=btn_editRoom, bd=0, bg='#084235', command=editRoom_fn).place(x=180, y=440) #EDITROOM_BTN ปุ่มแก้ไขห้องพัก *
    Button(frm_left_editRoom, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    
    #RIGHT SIDE [ ช่องกรอกห้องเลขที่ ชั้น ]
    ...
    entry_phonenum_editRoom = Entry(frm_right_editRoom_bg).place(x=350, y=60) #ENTRY กรอกห้องเลขที่ *
    ...
    entry_name_editRoom = Entry(frm_right_editRoom_bg).place(x=350, y=120) #ENTRY กรอกชั้น *
    Label(frm_right_editRoom_bg, text='ประเภทห้อง : ', bg='#DDDDDD').place(x=198, y=180)

    #ROOM TYPE
    room_type = ["รายเดือนแอร์", "รายเดือนแอร์", "รายเดือนพัดลม", "รายวันแอร์", "ห้องแถว"]
    roomtype = OptionMenu(frm_right_editRoom_bg, *room_type).place(x=350, y=180, width=310) #OPTION MENU

    #ROOM STATE
    Label(frm_right_editRoom_bg, text='สถานะห้อง : ', bg='#DDDDDD').place(x=198, y=250)
    room_state = ["ว่าง","ว่าง", "ไม่ว่าง", "ปรับปรุง"]
    roomstate = OptionMenu(frm_right_editRoom_bg, *room_state).place(x=350, y=250, width=310) #OPTION MENU
    Button(frm_right_editRoom_bg, image=btn_edit,bd=0, bg='#DDDDDD',).place(x=485, y=350) #EDIT_BTN ปุ่มแก้ไข *

#SERVICE FRAME [ หน้าต่างบริการต่างๆของโปรแกรม ]
def service_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_service, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    ...
    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมซ้าย ]
    Button(frm_left_service, image=btn_ratemanage, bd=0, bg='#084235', command=ratemanage_fn).place(x=180, y=180) #RATEMANGE_BTNS ปุ่มกำหนดอัตราค่าบริการ *
    Button(frm_left_service, image=btn_payment, bd=0, bg='#084235',command=payment_fn).place(x=180, y=280) #PAYMENT_BTN ปุ่มชำระค่าบริการ *
    Button(frm_left_service, image=btn_help, bd=0, bg='#084235',command=help_fn).place(x=180, y=380) #HELP_BTN ปุ่มบริการช่วยเหลือ *
    Button(frm_left_service, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
...
#RATEMANGEMENT FRAME [ หน้าจต่างกำนดค่าบริการของโปรแกรม ]
def ratemanage_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_ratemanage, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ป่มหน้าหลัก *

    #FRAME RIGHT
    frm_right_ratemanage = Frame(frm_main_ratemanage, bg='white')
    frm_right_ratemanage.place(x=651,y=0, width= 1269, height=1080)

    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมทางซ้าย ]
    ...
    Button(frm_right_ratemanage, width=25, height=20, bd=0, bg='#DDDDDD', command=roomrate_fn).place(x=150, y=200) #ROOMRATE_BTN ปุ่มอัตราค่าห้องพัก *
    Label(frm_right_ratemanage, image=btn_room, bd=0, bg='#DDDDDD').place(x=315, y=430)
    Button(frm_right_ratemanage, width=25, height=20, bd=0, bg='#DDDDDD', command=waterelectricrate_fn).place(x=750, y=200) #WATERELECTRICRATE_BTN S ปุ่มอัตราค่าน้ำค่าไฟ *
...
#ROOMRATE FRAME [ หน้าต่างการกำหนดอัตราค่าบริการของห้องพัก ]
def roomrate_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_roomrate, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    ...
    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมทางซ้าย ]
    Button(frm_left_roomrate, image=btn_ratemanage, bd=0, bg='#084235', command=ratemanage_fn).place(x=180, y=180) #RATEMANGE_BTN ปุ่มกำหนดอัตราค่าบริการ *
    Button(frm_left_roomrate, image=btn_payment, bd=0, bg='#084235',command=payment_fn).place(x=180, y=280) #PAYMENT_BTN ปุ่มลำระค่าบริการ *
    Button(frm_left_roomrate, image=btn_help, bd=0, bg='#084235',command=help_fn).place(x=180, y=380) #HELP_BTN ปุ่มบริการช่วยเหลือ *
    Button(frm_left_roomrate, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ช่องกรอกราคาเดิม ราคาใหม่ , ปุ่มบันทึก ]
    ...
    room_type = ["รายเดือนแอร์", "รายเดือนแอร์", "รายเดือนพัดลม", "รายวันแอร์", "ห้องแถว"]
    roomtype = OptionMenu(frm_right_roomrate_bg, *room_type).place(x=320, y=60, width=310) #OPTION MENU
    Label(frm_right_roomrate_bg, text='ราคาเดิม : ', bg='#DDDDDD').place(x=190, y=120)
    entry_oldrate_roomrate = Entry(frm_right_roomrate_bg).place(x=320, y=120) #ENTRY กรอกราคาเดิม *
    Label(frm_right_roomrate_bg, text='ราคาใหม่ : ', bg='#DDDDDD').place(x=189, y=180)
    entry_oldrate_roomrate = Entry(frm_right_roomrate_bg).place(x=320, y=180) #ENTRY กรอกราคาใหม่ *
    Button(frm_right_roomrate_bg, image=btn_save, bg='#DDDDDD', bd=0).place(x=450, y=280) #SAVE_BTN ปุ่มบันทึก *

#WATERELECTRICRATE FRAME [ หน้าต่างกำหนดอัตราค่าน้ำค่าไฟต่อหน่วย ]
def waterelectricrate_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_waterelec, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    ...
    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมทางซ้าย ]
    Button(frm_left_waterelec, image=btn_ratemanage, bd=0, bg='#084235', command=ratemanage_fn).place(x=180, y=180) #RATEMANGE_BTN ปุ่มกำหนดอัตราค่าบริการ *
    Button(frm_left_waterelec, image=btn_payment, bd=0, bg='#084235',command=payment_fn).place(x=180, y=280) #PAYMENT_BTN ปุ่มชำระค่าบริการ *
    Button(frm_left_waterelec, image=btn_help, bd=0, bg='#084235',command=help_fn).place(x=180, y=380) #HELP_BTN ปุ่มบริการช่วยเหลือ *
    Button(frm_left_waterelec, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ช่องกรอกค่าน้ำ +ค่าน้ำ  ค่าไฟ +ค่าไฟ ]
    ...
    entry_waterrate_waterelec = Entry(frm_right_waterelec, width=15).place(x=250, y=225) #ENTRY กรอกราคาน้ำ *
    ...
    entry_watercharge_waterelec = Entry(frm_right_waterelec, width=15).place(x=850, y=225) #ENTRY กรอกราคาบวกเพิ่ม *
    ...
    entry_electricrate_waterelec = Entry(frm_right_waterelec, width=15).place(x=250, y=655) #ENTRY กรอกราคาไฟ *
    ...
    entry_electriccharge_waterelec = Entry(frm_right_waterelec, width=15).place(x=850, y=655) #ENTRY กรอกราคาบวกเพิ่ม *
    Button(frm_right_waterelec, image=btn_save, bd=0, bg='#DDDDDD').place(x=905, y=800)

#PAYMENT FRAME [ ปุ่มอัตราค่าบริการ ชำระค่าบริการ บิรการช่วยเหลือ หน้าหลัก , ช่องกรอกเบอร์ ชื่อ นามสกุล ประเภทห้อง ค่าน้ำ ค่่าไฟ ค่าเช่าห้อง รวม ] IN RATE MANAGEMENT
def payment_fn() : 
    #MAIN
    root.title("Riski Apartment : ชำระค่าบริการ")
    ...
    #LOGO
    Button(frm_left_payment, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    ...
    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมซ้าย ]
    Button(frm_left_payment, image=btn_ratemanage, bd=0, bg='#084235', command=ratemanage_fn).place(x=180, y=180) #RATEMANAGE_BTN ปุ่มอัตราค่าบริการ *
    Button(frm_left_payment, image=btn_payment, bd=0, bg='#084235',command=payment_fn).place(x=180, y=280) #PAYMENT_BTN ปุ่มชำระค่าบริการ *
    Button(frm_left_payment, image=btn_help, bd=0, bg='#084235',command=help_fn).place(x=180, y=380) #HELP_BTN ปุ่มบริการช่วยเหลือ *
    Button(frm_left_payment, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ช่องกรอกเบอร์ ชื่อ นามสกุล ประเภทห้อง ค่าน้ำ ค่่าไฟ ค่าเช่าห้อง รวม ]
    ...
    entry_phone_payment = Entry(frm_right_payment_bg).place(x=270, y=60) #ENTRY กรอกเบอร์ *
    ...
    entry_name_payment = Entry(frm_right_payment_bg).place(x=270, y=120) #ENTRY กรอกชื่อ นามสกุล *
    Label(frm_right_payment_bg, text='ประเภทห้อง : ', bg='#DDDDDD').place(x=120, y=180)
    entry_roomtype_payment = Entry(frm_right_payment_bg).place(x=270, y=180) #ENTRY กรอกประเภทห้อง *
    Label(frm_right_payment_bg, text='ค่าเช่าห้อง : ', bg='#DDDDDD').place(x=130, y=240)
    entry_rent_payment = Entry(frm_right_payment_bg).place(x=270, y=240) #ENTRY กรอกค่าเช่าห้อง *
    Label(frm_right_payment_bg, text='ค่าไฟ : ', bg='#DDDDDD').place(x=175, y=300)
    entry_electric_payment = Entry(frm_right_payment_bg).place(x=270, y=300) #ENTRY กรอกค่าไฟ *
    Label(frm_right_payment_bg, text='ค่าน้ำ : ', bg='#DDDDDD').place(x=175, y=360)
    entry_water_payment = Entry(frm_right_payment_bg).place(x=270, y=360) #ENTRY กรอกค่าน้ำ *
    Label(frm_right_payment_bg, text='รวม : ', bg='#DDDDDD').place(x=190, y=420)
    entry_total_payment = Entry(frm_right_payment_bg).place(x=270, y=420) #ENTRY กรอกรวม *
    Button(frm_right_payment_bg, image=btn_invoices, bd=0, bg='#DDDDDD').place(x=150, y=600) #INVOICES_BTN ปุ่มพิมพ์ใบ *
    Button(frm_right_payment_bg, image=btn_paystat, bd=0, bg='#DDDDDD', command=paymentstatus_fn).place(x=400, y=600) #PAYSTAT_BTN ปุ่มสถานะการชำระ *

#HELP FRAME [ปุ่มอัตราค่าบิรการ ชำระค่าบริการ บริการช่วยเหลือ หน้าหลัก , กรอกวันที่ เรื่องที่แจ้ง เจ้าหน้าที่ ] IN RATE MANAGEMENT 
def help_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_help, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    ...
    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมทางซ้าย]
    Button(frm_left_help, image=btn_ratemanage, bd=0, bg='#084235', command=ratemanage_fn).place(x=180, y=180) #RATEMANAGE_BTN ปุ่มอัตราค่าบิรการ *
    Button(frm_left_help, image=btn_payment, bd=0, bg='#084235',command=payment_fn).place(x=180, y=280) #PAYMENT_BTN ปุ่มชำระค่าบริการ *
    Button(frm_left_help, image=btn_help, bd=0, bg='#084235',command=help_fn).place(x=180, y=380) #HELP_BTN ปุ่มบริการช่วยเหลือ *
    Button(frm_left_help, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
 
    #RIGHT SIDE [ ช่องกรอกวันที่ เรื่องที่แจ้ง เจ้าหน้าที่ ]
    ...
    entry_date_help = Entry(frm_right_help_bg).place(x=230, y=50) #ENTRY กรอกวันที่ *
    ...
    entry_inform_help = Entry(frm_right_help_bg).place(x=230, y=110) #ENTRY กรอกเรื่องที่แจ้ง *
    Label(frm_right_help_bg, text='เจ้าหน้าที่ : ', bg='#DDDDDD').place(x=120, y=170)
    entry_adminname_help = Entry(frm_right_help_bg).place(x=230, y=170) #ENTRY กรอกเจ้าหน้าที่ *
    Button(frm_right_help_bg, image=btn_finish, bg='#DDDDDD', bd=0).place(x=360, y=240)

#DATAREPORTTABLE FRAME [ ปุ่มข้อมูล/รายงาน หน้าหลัก , ตาราง ] >> หน้าข้อมูล / รายงาน
def datareporttable_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_datareporttable, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    
    #LEFT
    Button(frm_left_datareporttable, image=btn_datareport, bd=0, bg='#084235', command=datareport_fn).place(x=125, y=185) #DATAREPORT_BTN ปุ่มข้อมูล/รายงาน *
    Button(frm_left_datareporttable, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
...
#DATAREPORT FRAME [ ] >> หน้าข้อมูล / รายงาน
def datareport_fn() :
    #MAIN
    root.title("Riski Apartment : ข้อมูล / รายงาน")
    ...
    #LOGO
    Button(frm_left_datareport, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    
    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมทางซ้าย]
    Button(frm_left_datareport, image=btn_datareport, bd=0, bg='#084235', command=datareport_fn).place(x=125, y=185) #DATAREPORT_BTN ปุ่มข้อมูล/รายงาน *
    Button(frm_left_datareport, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ปุ่มบันทึกการใช้บริการ รายรับ รายจ่าย รายได้าสุทธิ เรื่องที่รับแจ้ง ]
    Button(frm_right_datareport, image=btn_doc, width=250, height=350, bg='#DDDDDD', bd=0, command=servicelog_fn).place(x=170, y=100) #DOC_BTN ปุ่มบันทึกการใช้บริการ *
    Label(frm_right_datareport, text='บันทึกการใช้บริการ', fg='#376957', bg='white').place(x=210, y=470)
    Button(frm_right_datareport, image=btn_income, width=250, height=350, bg='#DDDDDD', bd=0, command=income_fn).place(x=535, y=100) #INCOME_BTN ปุ่มรายรับ *
    Label(frm_right_datareport, text='รายรับ', fg='#376957', bg='white').place(x=630, y=470)
    Button(frm_right_datareport, image=btn_pay, width=250, height=350, bg='#DDDDDD', bd=0, command=pay_fn).place(x=900, y=100) #PAY_BTN ปุ่มรายจ่าย *
    Label(frm_right_datareport, text='รายจ่าย', fg='#376957', bg='white').place(x=994, y=470)
    Button(frm_right_datareport, image=btn_totalamt, width=250, height=350, bg='#DDDDDD', bd=0, command=totalamt_fn).place(x=170, y=530) #TOTALAMNT_BTN ปุ่มรายได้สุทธิ *
    Label(frm_right_datareport, text='รายได้สุทธิ', fg='#376957', bg='white').place(x=242, y=900)
    Button(frm_right_datareport, image=btn_information, width=250, height=350, bg='#DDDDDD', bd=0, command=receivenoti_fn).place(x=535, y=530) #INFORMATION_BTN ปุ่มเรื่องที่รับแจ้ง *
    Label(frm_right_datareport, text='เรื่องที่รับแจ้ง', fg='#376957', bg='white').place(x=610, y=900)

#SERVICELOG FRAME [ ปุ่มข้อมูล/รายงาน หน้าหลัก ] 
def servicelog_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_servicelog, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOMT_BTN LOGO ปุ่มหน้าหลัก *
    
    #LEFT SIDE [ ปุ่มทั้้งหมดของเฟรมทางซ้าย ]
    ...
    #RIGHT SIDE [ ช่องกรอกเบอร์ ชื่อ นามสกุล เลขห้อง ประเภทห้อง ชั้น ]
    ...
    entry_phonenum_servicelog = Entry(frm_right_servicelog_bg).place(x=350, y=60) #ENTRY กรอกเบอร์ * #>>> GET DATA FROM DATABASE SQLITE3       
    ...
    entry_name_servicelog = Entry(frm_right_servicelog_bg).place(x=350, y=120) #ENTRY กรอกชื่อ นามสกุล * #>>> GET DATA FROM  DATABASE SQLITE3
    Label(frm_right_servicelog_bg, text='เลขห้อง : ', bg='#DDDDDD').place(x=232, y=180)
    entry_roomnum_servicelog = Entry(frm_right_servicelog_bg).place(x=350, y=180) #ENTRY กรอกเลขห้อง *
    #room type
    Label(frm_right_servicelog_bg, text='ประเภทห้อง : ', bg='#DDDDDD').place(x=200, y= 240)
    entry_roomtype_servicelog = Entry(frm_right_servicelog_bg).place(x=350, y=240) #ENTRY กรอกประเภทห้อง *
    Label(frm_right_servicelog_bg, text='ชั้น : ', bg='#DDDDDD').place(x=275, y= 300)
    entry_floor_servicelog = Entry(frm_right_servicelog_bg).place(x=350, y=300) #ENTRY กรอกชั้น *
    Button(frm_right_servicelog_bg, image=btn_next,bd=0, bg='#DDDDDD', command=servicelogsave_fn).place(x=480, y=450) #NEXT_BTN ปุ่มถัดไป *

#SERVICELOG SAVE FRAME [ ปุ่มข้อมูล/รายงาน หน้าหลัก , ช่องกรอกเลขห้อง ค่าไฟ/หน่วย ค่าน้ำ/หน่วย เลขมิเตอร์น้ำ/ไฟ วันที่บันทึก ] #บันทึกการใช้บริการ ค่าน้ำ ค่าไฟ
def servicelogsave_fn() : 
    #MAIN
    root.title("Riski Apartment : บันทึกการใช้บริการ")
    ...
    #LOGO
    Button(frm_left_servicelogsave, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    
    #LEFT SIDE [ ปุ่มทั้งหมดของเฟรมทางซ้าย ]
    Button(frm_left_servicelogsave, image=btn_datareport, bd=0, bg='#084235', command=datareport_fn).place(x=125, y=185) #DATAREPORT_BTN ปุ่มข้อมูล/รายงาน *
    Button(frm_left_servicelogsave, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN หน้าหลัก *
    ...
    entry_roomnum_servicelogsave = Entry(frm_right_servicelogsave_bg).place(x=270, y=60) #ENTRY กรอกเลขห้อง *
    Label(frm_right_servicelogsave_bg, text='ค่าไฟ / หน่วย : ', bg='#DDDDDD').place(x=90, y=120)
    entry_electric_servicelogsave = Entry(frm_right_servicelogsave_bg).place(x=270, y=120) #ENTRY กรอกค่าไฟ *
    Label(frm_right_servicelogsave_bg, text='ค่าน้ำ / หน่วย : ', bg='#DDDDDD').place(x=92, y=180)
    entry_water_servicelogsave = Entry(frm_right_servicelogsave_bg).place(x=270, y=180) #ENTRY กรอกค่าน้ำ *
    Label(frm_right_servicelogsave_bg, text='เลขมิเตอร์น้ำ : ', bg='#DDDDDD').place(x=108, y=240)
    entry_watermeter_servicelogsave = Entry(frm_right_servicelogsave_bg).place(x=270, y=240) #ENTRY กรอกเลขมิเตอร์น้ำ *
    Label(frm_right_servicelogsave_bg, text='เลขมิเตอร์ไฟฟ้า : ', bg='#DDDDDD').place(x=82, y=300)
    entry_electricmeter_servicelogsave = Entry(frm_right_servicelogsave_bg).place(x=270, y=300) #ENTRY กรอกเลขมิเตอร์ไฟ *
    Label(frm_right_servicelogsave_bg, text='วันที่บันทึก : ', bg='#DDDDDD').place(x=130, y=360)
    entry_date_servicelogsave = Entry(frm_right_servicelogsave_bg).place(x=270, y=360) #ENTRY กรอกวันที่บันทึก *
...
#INCOME FRAME [ ปุ่มข้อมูล/รายงาน หน้าหลัก หา , ช่องกรอกวันเริ่มต้น วันสิ้นสุด ]
def income_fn() : 
    #MAIN
    ...
    #LOGO
    Button(frm_left_income, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    
    #LEFT SIDE [ ปุ่่มเฟรมทางซ้าย]
    Button(frm_left_income, image=btn_datareport, bd=0, bg='#084235', command=datareport_fn).place(x=125, y=185) #DATAREPORT_BTN ปุ่มข้อมูล/รายงาน *
    Button(frm_left_income, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ช่องกรอกวันเริ่มต้่น วันสิ่้นสุด ]
    ...
    entry_startdate_income = Entry(frm_right_income_bg).place(x=280, y=120) #ENTRY กรอกวันที่เริ่มต้น *
    ...
    entry_enddate_income = Entry(frm_right_income_bg).place(x=280, y=180) #ENTRY กรอกวันที่สิ้นสุด *
    Label(frm_right_income_bg, text='(วว/ดด/ปปปป)', bg='#DDDDDD').place(x=610, y=180)
    Button(frm_right_income_bg, image=btn_find,bd=0, bg='#DDDDDD', command=incometable_fn).place(x=330, y=350) #FIND_BTN ปุ่มหา *

#INCOMETABLE FRAME [ ปุ่มข้อมูล/รายงาน หน้าหลัก กลับ ปริ้นรายรับ ] #ตารางรายรับ  
def incometable_fn() : 
    #MAIN
    root.title("Riski Apartment : รายรับ")
    ...
    #LOGO
    Button(frm_left_incometable, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    
    #LEFT SIDE [ ปุ่มทั้งหมดทางซ้าย ]
    Button(frm_left_incometable, image=btn_datareport, bd=0, bg='#084235', command=datareport_fn).place(x=125, y=185) #DATAREPORT_BTN ปุ่มข้อมูล/รายงาน *
    Button(frm_left_incometable, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ปุ่มกลับ ปริ้นรายรับ ]
    Label(frm_right_incometable, text='รายรับ', font='Verdana 30 bold', bg='white', fg='#376957').place(x=580, y=80)
    Button(frm_right_incometable, image=btn_back, bd=0, bg='white', command=income_fn).place(x=550, y=880) #BACK_BTN ปุ่มย้อนกลับ *
    Button(frm_right_incometable, image=btn_printincome, bd=0, bg='white').place(x=850, y=880) #PRINTINCOME_BTN ปุ่มปริ้นรายรับ *
...
def pay_fn() :
    ...
    #LOGO 
    Button(frm_left_pay, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *

    #LEFT SIDE [ ปุ่มข้อมูล/รายงาน ]
    Button(frm_left_pay, image=btn_datareport, bd=0, bg='#084235', command=datareport_fn).place(x=125, y=185) #DATAREPORT_BTN ปุ่มข้อมูล/รายงาน *
    Button(frm_left_pay, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
    ...
    entry_startdate_pay = Entry(frm_right_pay_bg).place(x=280, y=120) #ENTRYS กรอกวันที่เริ่มต้น *
    ...
    entry_enddate_pay = Entry(frm_right_pay_bg).place(x=280, y=180) #ENTRY กรอกวันที่สิ้้นสุด *
    Label(frm_right_pay_bg, text='(วว/ดด/ปปปป)', bg='#DDDDDD').place(x=610, y=180)
    Button(frm_right_pay_bg, image=btn_find,bd=0, bg='#DDDDDD').place(x=330, y=350) #FIND_BTN ปุ่มหา *

#PAYMENTSTATUS FRAME [ ปุ่มอัตราค่าบริการ ชำระค่าบริการ บริการช่วยเหลือ หน้าหลัก ปริ้นใบ สำเร็จ , ช่องกรอกเบอร์โ?ร ชื่อ นามสกุล ]
def paymentstatus_fn() : 
    ...
    #LEFT SIDE [ ปุ่มอัตราค่าบริการ ชำระค่าบริการ บริการช่วยเหลือ หน้าหลัก ]
    Button(frm_left_paymentstatus, image=btn_ratemanage, bd=0, bg='#084235', command=ratemanage_fn).place(x=180, y=180) #RATEMANGE_BTN ปุ่มอัตราค่าบริการ *
    Button(frm_left_paymentstatus, image=btn_payment, bd=0, bg='#084235',command=payment_fn).place(x=180, y=280) #PAYMENT_BTN ปุ่มชำระค่าบริการ *
    Button(frm_left_paymentstatus, image=btn_help, bd=0, bg='#084235',command=help_fn).place(x=180, y=380) #HELP_BTN ปุ่มบริการช่วยเหลือ *
    Button(frm_left_paymentstatus, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #RIGHT SIDE [ ช่องกรอกเบอร์โทร ชื่อนามสกุล ]
    ...
    entry_phone_paymentstatus = Entry(frm_right_paymentstatus_bg).place(x=270, y=60) #ENTRY กรอกเบอร์โทร *
    ...
    entry_name_paymentstatus= Entry(frm_right_paymentstatus_bg).place(x=270, y=120) #ENTRY กรอกชื่อนามสกุล *
    ...
    paymentstatus = OptionMenu(frm_right_paymentstatus_bg, *payment_status).place(x=270, y=180, width=310) #OPTION MENU 
    Button(frm_right_paymentstatus_bg, image=btn_printreceipt, bd=0, bg='#DDDDDD' ).place(x=150, y=280) #PRINTRECEIPT_BTN ปริ้นใบ *
    Button(frm_right_paymentstatus_bg, image=btn_finish, bd=0, bg='#DDDDDD' ).place(x=450, y=280) #FINISH_BTN ปุ่มสำเร็จ *

#TOTAL AMOUNT FRAME [ ปุ่มข้อมูล/รายงาน หน้าหลัก , ช่องกรอกวันที่เริ่มต้น วันที่สิ้นสุด ]
def totalamt_fn() :
    #MAIN
    ...
    #LEFT SIDE [ ปุ่มข้อมูล/รายงาน sohks]yd ]
    Button(frm_left_totalamt, image=btn_datareport, bd=0, bg='#084235', command=datareport_fn).place(x=125, y=185) #DATAREPORT_BTN ปุ่มข้อมูล/รายงาน *
    Button(frm_left_totalamt, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *
    ...
    entry_startdate_totalamt = Entry(frm_right_totalamt).place(x=260, y=120) #ENTRY กรอกวันที่เริ่มต้น *
    ...
    entry_endate_totalamt = Entry(frm_right_totalamt).place(x=260, y=180) #ENTRY กรอกันที่สิ้้นสุด *
    Label(frm_right_totalamt, text='(วว/ดด/ปปปป)', bg='#DDDDDD',fg="#969696").place(x=570, y=178)
    Button(frm_right_totalamt, image=btn_find,bd=0, bg='#DDDDDD').place(x=330, y=250) #FIND_BTN ปุ่มหา *
    Button(frm_right_totalamt,image=btn_printtotalamt, bd=0 ,  bg="#DDDDDD").place(x=570,y=790) #PRINTTOTALAMT_BTN ปุ่มปริ้นใบรายได้สุทธิ *
...
#RECEIVE NOTIFICATION FRAME [ ปุ่มข้อมูล/รายงาน หน้าหลัก ]
def receivenoti_fn() : 
    #MAIN
    ...
    #LEFT SIDE [ ปุ่มข้อมูล/รายงาน หน้าหลัก ]
    Button(frm_left_receivenoti, image=btn_datareport, bd=0, bg='#084235', command=datareport_fn).place(x=125, y=185) #DATAREPORT_BTN ปุ่มข้อมูล/รายงาน *
    Button(frm_left_receivenoti, image=btn_home, bd=0, bg='#084235', command=home_fn).place(x=30, y=900) #HOME_BTN ปุ่มหน้าหลัก *

    #LOGO
    Button(frm_left_receivenoti, image=img_riskilogos, bd=0 , bg='#084235', command=home_fn).place(x=30, y=30) #HOME_BTN LOGO ปุ่มหน้าหลัก *
    ...
    Button(frm_right_receivenoti,image=btn_back,bd=0 ,  bg='#DDDDDD',command=datareport_fn).place(x=570,y=720) #BACK_BTN ปุ่มกลับ *

    #CALL TREEVIEW [ วันที่ เจ้าหน้าที่ เรื่องที่แจ้ง ]
