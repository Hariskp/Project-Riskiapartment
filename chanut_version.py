...
def home_fn() : #หน้า Home #By Haris
    ...
    Button(frm_left_home, image=btn_roommanage, bd=0, bg='#084235').place(x=180, y=480) #command ??
    Button(frm_left_home, image=btn_service, bd=0, bg='#084235').place(x=180, y=580) #command ??
...
def checkout_fn() : #หน้า Check Out #โค้ดนี้กำลังแก้ไขโดย นัท 07/04/2023 เวลา 2:30
    ...
    Button(frm_right_checkout_bg, image=btn_search, bd=0, bg='#DDDDDD').place(x=670, y=58)
...
def datareporttable_fn() :  # หน้าข้อมูล / รายงาน                     # แปะใน main !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    #MAIN
    root.title("Riski Apartment : Accountmanage")
...
def datareport_fn() : # หน้าข้อมูล / รายงาน                     # แปะใน main !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    #MAIN
    root.title("Riski Apartment : Accountmanage")
...
def servicelogsave_fn() : # บันทึกการใช้บริการ ค่าน้ำ ค่าไฟ
    #MAIN
    root.title("Riski Apartment : Accountmanage")
